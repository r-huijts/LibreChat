...
/* Model Consents */
import { createModelConsentMethods } from './modelConsent';

export type ModelConsentMethods = ReturnType<typeof createModelConsentMethods>;
...
export function createMethods(mongoose: typeof import('mongoose')): AllMethods {
  return {
    ...
    ...createModelConsentMethods(mongoose),
  };
}
